...
const Settings = () => {
  ...
  const navigateToProject = ()=>{
    navigate("https://github.com/AkhilPratapSingh09/react-weather-app-master");
  }

  const navigateToGithub = () =>{
    navigate("https://github.com/AkhilPratapSingh09");
  }
      ...
      <section className="container-fluid width-toggle-5 m-auto">
        ...
        <section className="support-developer d-flex align-items-start justify-content-center w-100 flex-column">
          ...
          <section className="sponsor-me text-muted text-start">
            ...
            Hi, I'm Akhil Pratap Singh. I built this weather app on 02/04/2023 for
            my college work. This project helps me in sharpen my react skills.
